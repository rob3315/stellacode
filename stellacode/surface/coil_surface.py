...
from .abstract_surface import AbstractSurfaceModule, Surface
from .current import AbstractCurrent
from stellacode.tools.laplace_force import laplace_force


# class AbstractCoilModule(AbstractSurfaceModule):
#     """A class used to:
...
#         super().compute_surface_attributes(deg=deg)
#         self.current_op = self.current._get_matrix_from_grid(self.grids)
#         self.j_surface = self.get_j_surface()
#         for k in [
#             "xyz",
#             "jac_xyz",
#             "normal",
...
#             "principle_min",
#         ]:
#             setattr(self, k, getattr(self.surface, k))
